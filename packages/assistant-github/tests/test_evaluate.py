...
from assistant_github.platforms.pull_requests.evaluate import (
    PRSnapshot,
    _make_resolver as pr_make_resolver,
    _snapshot_from_frontmatter as pr_snapshot_from_fm,
)
from assistant_github.platforms.issues.evaluate import (
    IssueSnapshot,
...
from assistant_github.platforms.issues.const import (
