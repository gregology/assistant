...
from gaas_email.platforms.inbox.evaluate import (
    EmailSnapshot,
    _make_resolver,
    _snapshot_from_frontmatter,
)
from gaas_email.platforms.inbox.const import (
...
class TestSafetyConstants:
    ...
    def test_irreversible_actions_subset_of_simple(self):
        from gaas_email.platforms.inbox.const import IRREVERSIBLE_ACTIONS, SIMPLE_ACTIONS
